...
function regCallback(file, data) {
    ...
    if(data.num==1){
    	...
    	$('#licence1').css({'background':'url('+src1+') no-repeat','background-size':'100% 100%'});
    }else if(data.num==2){
    	console.log(urls);
		sessionStorage.setItem('src2',urls);
		var src2=sessionStorage.getItem('src2');
		$('#licence2').css({'background':'url('+src2+') no-repeat','background-size':'100% 100%'});
    }else if(data.num==3){
    	console.log(urls);
		sessionStorage.setItem('src3',urls);
		var src3=sessionStorage.getItem('src3');
		$('#licence3').css({'background':'url('+src3+') no-repeat','background-size':'100% 100%'});
    }else if(data.num==4){
    	console.log(urls);
		sessionStorage.setItem('src4',urls);
		var src4=sessionStorage.getItem('src4');
		$('#licence4').css({'background':'url('+src4+') no-repeat','background-size':'100% 100%'});
    }
