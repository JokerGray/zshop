    ...
    $.fn.circliful = function(options) {
        ...
        var settings = $.extend({
         ...
         return this.each(function() {
                ...
                //新添加渐变
				if($(this).data('pgcolor') != undefined) {
                    pgcolor = $(this).data('pgcolor');
                } 
			  ...
			  function animate(current) {
				...
				// line color
				if(pgcolor==''||pgcolor==undefined){
					context.strokeStyle = fgcolor;
					context.stroke();
				}else{
					var grd=context.createLinearGradient(x,y,x+radius,0);
					grd.addColorStop(0,fgcolor);
					grd.addColorStop(1,pgcolor);
