$(function(){
	  ...
	  function showTable(re){
	  	...
	  	for(var i=0;i<re.data.length;i++){
	  		...
	  		tdHtml+='<tr id="'+re.data[i].userId+'"><td>'+(i+1)+'</td><td>'+re.data[i].name+'</td><td><div class="showAnchor"><img src="'+re.data[i].userPic+'"/></div></td><td>'+re.data[i].sex+'</td><td>'+re.data[i].userName+'</td><td>休息中</td><td><span class="btn btn-gray closeBtn">关闭直播</span></td></tr>'
	  		...
	  		re.data[i].userName+'</td><td>直播中</td><td><span class="btn btn-gray closeBtn" recordid="'+re.data[i].shopLiveRecord.id+'" usertype="'+re.data[i].shopLiveRecord.type+'">'+
	  		'关闭直播</span></td></tr>'
	  		}
	  	}
