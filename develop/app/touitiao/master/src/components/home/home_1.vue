    ...
    <div class="homeContent">
      ...
      <cube-slide @change="getPage"
        ...
        <cube-slide-item v-for="(item,index) in cateList" :key="index">
          ...
          <div class="pageZW" v-if="index!==loadingShow"><loading></loading></div>
          <newsList v-bind="{active:active,cateId:item.channelId}" v-if="index==isShow" ref="newsList" @hideLoading="hideLoading"></newsList>
        </cube-slide-item>
      </cube-slide>
