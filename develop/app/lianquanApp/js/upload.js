function runupload($loadbtn,$inputBtn) {
	accessid = ''
	accesskey = ''
	host = ''
	policyBase64 = ''
	...
	var loadbtnId=$loadbtn.attr("id");

	var uploader = new plupload.Uploader({
		runtimes: 'html5,flash,silverlight,html4',
		browse_button: loadbtnId,
		...
		init: {
			...
			FileUploaded: function(up, file, info) {
				...
				if (info.status == 200) {
					...
					console.log(urls);
					var imgBox = '<div class="imgBox"><img src="' + urls + '"/><span class="delBtn"></span></div>';
					$inputBtn.before(imgBox);
