...
var TableInit = function () {
  ...
  oTableInit.Init = function () {
    $('#table').bootstrapTable({
      ...
      columns: [
        ...
        {field: 'merchantId', title: '收入来源', align: "center", width: 150, sortable: true}, // 收入来源
        {field: 'createTime', title: '开始日期', sortable: true, width: 160, align: "center"},// 开始日期
        {field: 'createTime', title: '截止日期', sortable: true, width: 160, align: "center"},// 截止日期
        {field: 'accountName', title: '次数', sortable: true, width: 150, align: "center"},// 次数
        {
          field: 'merchantType', title: '收入金额', sortable: true, width: 150, align: "center",
  ...
  oTableInit.queryParams = function (params) {
    ...
    jsonData = "{'billType':8,'pageNo':" + pageNo + ",'pageSize':" + pageSize + "}";
