...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'transactionAmount', title:'余额', width: 150, align : "center",
                    formatter: function(res){
                        return fmoney(res, 2);
                    }
                }, // 金额格式化
    ...
    oTableInit.queryParams = function (params) {
        ...
        if(startTimes ==""){
            ...
            // jsonData = "{'dataTable':{'createTimeStart':'"+startTimes+"','createTimeEnd':'"+endTimes+"','pageNo':"+pageNo+",'pageSize':1000}}";
