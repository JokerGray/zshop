...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'merchantType', title:'账户类别', width: 150, align : "center",// 账户类别
    ...
    oTableInit.queryParams = function (params) {
        ...
        var jsonData="";
        var pageNo = "1";//返回第一页
        // var pageNo = params.pageNumber;//当前第几页
        var pageSize = params.pageSize;//每页显示的10行
        var version = "1";
        ...
        if(selectview=='-- 全部 --'){
            selectview='';
        }else if(selectview=='正式版'){
            selectview='1';
        }else if(selectview=='免费试用版'){
            selectview='0';
        };
