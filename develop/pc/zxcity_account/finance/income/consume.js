...
//				{ field: 'accountName', title:'用户姓名', sortable: true, width: 150, align : "center" }, //用户姓名
				...
				{ field: 'regMode', title:'账户类别', sortable: true, width: 100, align : "center" },// 类别
				{ field: 'goodsName', title:'商品名称',  sortable: true, width: 160, align : "center" },// 商品名称
				{ field: 'goodsPrice', title:'商品价格', sortable: true, width: 150, align : "right",
					formatter: function(money){
						return fmoney(money, 2);
					}
				}, // 金额格式化  // 使用金额
				{ field: 'number', title:'数量',  sortable: true, width: 160, align : "center" },// 数量
				{ field: 'transTime', title:'消费时间',  sortable: true, width: 160, align : "center" },// 使用时间
				{ field: 'subTotal', title:'小计',  sortable: true, width: 160, align : "center" },// 使用时间
...
function getSearchParam(pageNo, pageSize){
    ...
    var jsonData = '';
    if(pageNo && pageNo){
    	jsonData = "{'startTime':'"+startTimes+"', 'endTime':'"+endTimes+"','rechargeModular':'"+moduleNo+"','accountName':'"+station+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}"
    }else{
    	jsonData = "{'startTime':'"+startTimes+"', 'endTime':'"+endTimes+"','rechargeModular':'"+moduleNo+"','accountName':'"+station+"'}";
    }
    return jsonData
}
    //查询搜索事件
