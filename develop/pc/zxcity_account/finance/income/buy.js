...
//				{ field: '', title:'用户姓名', sortable: true, width: 150, align : "center" }, //用户姓名
				...
				{ field: 'regMode', title:'类别', sortable: true, width: 100, align : "center",
...
//						}
				...
				{ field: 'rechargeMoney', title:'购买金额', sortable: true, width: 150, align : "right",
					formatter: function(money){
						return fmoney(money, 2);
					}
				},// 购买金额 // 金额格式化
				{ field: 'payTime', title:'购买时间',  sortable: true, width: 160, align : "center" },// 购买时间
//				{ field: '', title:'发票', sortable: true, width: 100, align : "center",
//					formatter: function(res){
//						if(res==0){
//							return '要';
//						}else if(res==1){
...
//					} 
//				},// 发票
//				{ field: '', title:'备注', sortable: true, width: 300, align : "center",
