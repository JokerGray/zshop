...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'applyTime', title:'申请时间', sortable: true, width: 150, align : "center",
                    formatter: function(res){
                        if(res==null){
                            return res='-';
                        }else{
				...
				{ field: 'payTime', title:'支付时间', sortable: true, width: 150, align : "center",
                    formatter: function(res){
                        if(res==null){
                            return res='-';
                        }else{
				...
				{ field: 'remark', title:'备注', width: 150, align : "center",
					formatter: function(remark){
                        if(remark==""){
                            ...
                            var note='<div class="note">'+newStrByNum(remark,15)+'</div>'
                            return note;
                        }
					}
				}//备注
    ...
    oTableInit.queryParams = function (params) {
        ...
        if($('#accountnamer').val() =="" && startTimes ==""){
            jsonData = "{'state':'1','ismerchant':'"+selectplate+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
        }else if(startTimes !=="" && endTimes ==""){
            jsonData = '{"state":"1","ismerchant":"'+selectplate+'","accountName":"'+station+'","applyTimeStart":"'+startTimes+' 00:00:00'+'","pageNo":'+pageNo+',"pageSize":'+pageSize+'}';
        }else if(startTimes !=="" && endTimes !==""){
            jsonData = '{"state":"1","ismerchant":"'+selectplate+'","accountName":"'+station+'","applyTimeStart":"'+startTimes+' 00:00:00'+'","applyTimeEnd":"'+endTimes+' 23:59:59'+'","pageNo":'+pageNo+',"pageSize":'+pageSize+'}';
        }else{
            jsonData = "{'state':'1','ismerchant':'"+selectplate+"','accountName':'"+station+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
        }
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            if($('#accountnamer').val() =="" && startTimes ==""){
                jsonData = "{'state':'1','ismerchant':'"+selectplate+"'}";
            }else if(startTimes !=="" && endTimes ==""){
                jsonData = '{"state":"1","ismerchant":"'+selectplate+'","accountName":"'+station+'","applyTimeStart":"'+startTimes+' 00:00:00'+'"}';
            }else if(startTimes !=="" && endTimes !==""){
                jsonData = '{"state":"1","ismerchant":"'+selectplate+'","accountName":"'+station+'","applyTimeStart":"'+startTimes+' 00:00:00'+'","applyTimeEnd":"'+endTimes+' 23:59:59'+'"}';
            }else{
                jsonData = "{'state':'1','ismerchant':'"+selectplate+"','accountName':'"+station+"'}";
            }
