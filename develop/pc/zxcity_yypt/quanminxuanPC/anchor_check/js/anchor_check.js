	      ...
	      var tablefooter="</tbody></table>";
			if(re.data.list.length){
				...
				for(var i=0;i<re.data.list.length;i++){
					tableCont+='<tr id="'+re.data.list[i].ids+'"><td>'+(i+1)+'</td><td>'+re.data.list[i].name+'</td><td>'+re.data.list[i].shopName+'</td><td>'+re.data.list[i].shopId+'</td><td>'+re.data.list[i].shopAddress+'</td>'+
