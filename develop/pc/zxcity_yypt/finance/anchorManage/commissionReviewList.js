        ...
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'merchantName', title:'申请商户', align : "center", width: 150 },
					{
						field:'name', title:'主播姓名', align : "center", width: 150 
					},
				{ field: 'realMoney', title:'申请金额',  width: 100, align : "center",
					formatter: function(value,row,index){
						
						return value && value ? fmoney(value, 2) : null;
					}
				},
				{ field: 'taxType', title:'税务类型', width: 150, align : "center" },
				{ field: 'afterTaxAmount', title:'实付金额', width: 160, align : "center" ,
					formatter: function(value,row,index){
						return value && value ? fmoney(value,2) : null;
					}
				},
				{ field: 'laborTax', title:'扣税金额',  width: 150, align : "center" ,
					formatter: function(value,row,index){
						return value && value ? fmoney(value,2) : null;
					}
				},
				{ field: 'status', title:'审核结果',  width: 150, align : "center",
					formatter: function(value,row,index){
						var text;
						if(value == '0'){
							text = '';
