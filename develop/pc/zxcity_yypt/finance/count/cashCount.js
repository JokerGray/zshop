...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
                ...
                { field: 'count', title:'提现次数', sortable: true, width: 150, align : "center" }, // 提现次数
                { field: 'money', title:'提现金额', sortable: true, width: 150, align : "center",
            ...
            onLoadSuccess: function (res) {
            	//展现视图
	           	 try {
	           		  ...
	           		  var option = echartsCustomerFunction.initOption('提现统计', 
	           				  					['提现次数','提现金额'],
	           				  				xData, 
    ...
    oTableInit.queryParams = function (params) {
        var cmd = " payTransactionLog/selWithdrawCashSummary";
        var jsonData="";
        ...
        jsonData = "{'type':'"+typeStr+"','ismerchant':'"+selectview1+"','returnTimeStart':'"+qBeginTime+"','returnTimeEnd':'"+qEndTime+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            jsonData = "{'type':'"+typeStr+"','ismerchant':'"+selectview1+"','returnTimeStart':'"+qBeginTime+"','returnTimeEnd':'"+qEndTime+"'}";
            
            //1. 发送下载请求 , 业务不同，向server请求的地址不同
            var excelUrl = reqAjax('payExcel/exportWithdrawCashSummary', jsonData);
            if(excelUrl.code != 1){
