  ...
  oTableInit.Init = function () {
    $('#table').bootstrapTable('destroy').bootstrapTable({
      url: '/zxcity_restful/ws/rest',
            ...
            { field: 'billMark',title:'收入来源', width: 150, align: "center"},
            { field: 'billTypeStr', title:'收入类型', width: 160, align : "center" ,//交易类型0 充值/1 消费/2 退货/3 提现结算/4 提现退回/5 转出到子账户/6 子账户转入/7 确认收货/8 产生盈利
            	formatter: function(res){
                if(res==null){
                  return res="-";
                }else{
            ...
            { field: 'createtime', title:'注册时间',  sortable: true, width: 160, align : "center",
              formatter: function(res){
                if(res==null){
                  return res="-";
                }else{
    ...
    oTableInit.queryParams = function (params) {
        ...
        if(startTimes ==""){
          ...
          jsonData = "{'billTimeStart':'"+startTimes+' 00:00:00'+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
        }else if(startTimes !=="" && endTimes !==""){
          jsonData = "{'billTimeStart':'"+startTimes+' 00:00:00'+"','billTimeEnd':'"+endTimes+' 23:59:59'+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
        }
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            if(startTimes ==""){
              ...
              jsonData = "{'billTimeStart':'"+startTimes+' 00:00:00'+"'}";
            }else if(startTimes !=="" && endTimes !==""){
              jsonData = "{'billTimeStart':'"+startTimes+' 00:00:00'+"','billTimeEnd':'"+endTimes+' 23:59:59'+"'}";
            }
            var excelUrl = reqAjax('payExcel/exportInComeDetail', jsonData);
            if(excelUrl.code != 1){
