(function($){
    ...
    var USER_URL =  {
        RESOURLIST : 'operations/statisticsRepositoryByUser', //(客服统计知识点)
        GROUPLIST:'operations/statisticsRepositoryByGroup' //根据客服分组统计知识点
    };
...
//加了入参的公用方法
    ...
    function pageCallback(index, limit,beginTime,endTime,type) {
        ...
        if(type==1){
            ...
            return getData(USER_URL.GROUPLIST, JSON.stringify(param));
        }
