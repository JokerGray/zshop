(function($){
    ...
    var USER_URL =  {
        RESOURLIST : 'operations/serviceGroupChatStatics' //(报表)
    };
    ...
    //报表
    function templeTable(beginTime,endTime,test,e){
        var obj = tableInit(e, [
                [
                    {
                        title: '客服组',
...
//加了入参的公用方法
    function tableInit(tableId, cols, pageCallback, test,beginTime,endTime) {
