    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeNodeIcoStyle: function (setting, node) {
                ...
                if (!node.isAjaxing) {
                    var isParent = data.nodeIsParent(setting, node);
                    var icon = (isParent && node.iconOpen && node.iconClose) ? (node.open ? node.iconOpen : node.iconClose) : null;
        ...
        init: function (obj, zSetting, zNodes) {
            ...
            var zTreeTools = {
                ...
                expandAll: function (expandFlag, callback) {
                    ...
                    view.expandCollapseSonNode(setting, null, expandFlag, true, callback);
                    return expandFlag;
                },
