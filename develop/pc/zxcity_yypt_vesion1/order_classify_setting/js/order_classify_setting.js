(function($){
    ...
    var pid = '';
    var USER_URL = {
        RESOURLIST : 'operations/getJobOrderCategories', //(查询工单类别)
        ADDRESOURCE : 'operations/addJobOrderCategory',//(新增工单类别)
        UPDATERESOURCE :'operations/updateJobOrderCategory',//(修改工单类别)
