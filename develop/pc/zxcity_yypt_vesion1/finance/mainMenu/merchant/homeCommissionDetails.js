...
$(function () {
    ...
    status = getRequestAddressUrlParameter('status');
    commissionStatus = getRequestAddressUrlParameter('commissionStatus');
    employeeCommissionStatus= getRequestAddressUrlParameter('employeeCommissionStatus');
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            {field: 'merchantPhone', title:'商户手机号', align : "center", width: 80,},
            ...
            { field: 'referenceRealAmount', title:'佣金(含税)',  width: 100, align : "center"},
            ...
            { field: 'upgradeAutitTime', title:'间隔天数',  width: 150, align : "center",
              formatter: function (res,row) {
                if(res){
                  ...
                  // 当前时间减去 过去时间
                  return parseInt(intervalTime/(24*60*60*1000))+"天";
                }
              }
            },
			  ],
