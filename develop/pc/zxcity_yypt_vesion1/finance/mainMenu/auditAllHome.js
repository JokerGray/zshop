...
//请求统计信息
function init(){
	var cmd = "mainMenu/auditAllIndex";
	...
	$.ajax({
		...
		success : function(res) {
			if(res.code == 1){
				...
				var workOrderRealSum = res.data.workOrderRealSum;
				...
				$("#workOrderRealSum").text(fmoney(workOrderRealSum, 2));
			}else{
				layer.msg(res.msg);
			}
		},
...
$(".txshenqing").click(function(){
	...
	var name = "提现审核列表";
	var url = "finance/pool/cash.html?startTime="+startTime+"&endTime="+endTime+"&state=-1";
	addTabs(url, name);	
});
...
$(".zblaowu").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "主播劳务列表";
	var url = "finance/anchorManage/commissionReviewList.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
...
$(".zbqiye").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "主播企业列表";
	var url = "finance/anchorManage/invoiceReviewList.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
...
$(".shsjxianxia").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "线下商户升级列表";
	var url = "finance/merchant/merchantUpgradeOffLineList.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
...
$(".shsjxianshang").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "线上商户升级列表";
	var url = "finance/merchant/merchantUpgradeOnLineList.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
...
$(".tjryongjin").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "线上推荐人佣金列表";
	var url = "finance/merchant/referenceCommissionList.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
...
$(".workorder").click(function(){
	...
	var endTime = $('#qEndTime').val();
	var name = "专业制作审核列表";
	var url = "finance/professionallyProduced/orderReviewlog.html?startTime="+startTime+"&endTime="+endTime;
	addTabs(url, name);	
});
