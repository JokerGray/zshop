...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
                ...
                {
                	field: 'rolesStr', title:'平台角色', width: 200, align : "center"   //角色
                },  
				{
    ...
    //              },// 支付时间
				...
				{ field: 'inspectionStatus', title:'自检状态', align : "center",
					formatter : function(res) {
						if (res == "0") {
				...
				{field: 'id',title:'手动自检',width: 10,align : "center",
	                formatter: function(res,data,index){
						return '<button onclick="inspection('+data.userId+','+index+')" type="button" class="btn btn-info btn-sm edit" aria-hidden="true" style="padding-top: 0; padding-bottom: 0;"">自检</button>';
	                }
	           }
			],
	...
	function inspection(userId, index){
		params = '{"userId":"'+userId+'"}';
		res = reqAjax("accountQualityInspection/doAQIByUserId", params);
		if(res.code == 1){
			layer.msg("自检成功！");
			...
			$('#table').bootstrapTable('updateCell',{index:index,field:'inspectionStatus',value:status});
