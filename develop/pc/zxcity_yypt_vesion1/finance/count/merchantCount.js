...
//      searchText: '',
      ...
      columns: [
        ...
        {field: 'regular', title: '商户类型', width: 150, align: "center" },
        {field: 'accountName', title: '商户名称', width: 150, align: "center",
        ...
        {field: 'totalSales', title: '销售次数', sortable: true, width: 150, align: "center" },
...
//          callBack();
  ...
  oTableInit.queryParams = function (params) {
    var cmd = "payTransactionLog/selMerchantStatistics";
...
$("#excelbtn").on("click", function downloadFile() {
  ...
  try {
    ...
    var excelUrl = reqAjax('payExcel/exportMerchantStatistics', getSearchParam());
    //2.获取下载URL
