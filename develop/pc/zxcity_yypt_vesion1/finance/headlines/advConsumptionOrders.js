...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
            {
              ...
              formatter: function(value,row,index){
                return index+1;
    				...
    				{field: 'id', title:'流水号', align : "center", width: 80,},
    				{ field: 'advUsername', title:'广告主', align : "center", width: 150 },
            ...
            { field: 'companyIncome', title:'公司收入',  width: 100, align : "center",
              formatter: function (res) {
                 return fmoney(res, 2);
			      ...
			      { field: 'supplierName', title:'平台供应商',  width: 150, align : "center" },
            { field: 'supplierType', title:'供应商类型',  width: 150, align : "center",
              formatter: function (res) {
            ...
            { field: 'startTime', title:'时间',  width: 200, align : "center" },
			  ],
