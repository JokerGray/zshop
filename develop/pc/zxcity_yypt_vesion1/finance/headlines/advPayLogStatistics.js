...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            { field: 'totalRecharge', title:'充值总额', align : "center", width: 150,
              formatter: function (res) {
                 return fmoney(res, 2);
              }
            },
            { field: 'rechargeTimes', title:'充值次数',  width: 100, align : "center"},
			      { field: 'remainingMoney', title:'余额',  width: 150, align : "center",
              formatter: function (res) {
                 return fmoney(res, 2);
              }
            },
    ...
    oTableInit.queryParams = function (params) {
        var cmd = "headlines/selectStatisticsList";
        var jsonData="";
