...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
			...
			columns: [
				...
				{ field: 'username', title:'员工名', align : "center", width: 150 },
				{ field: 'referenceLevelStr', title:'线下办理', width: 150, align : "center" },
				{ field: 'partner', title:'线上推荐', width: 160, align : "center" }
			],
			*/
    ...
    oTableInit.queryParams = function (params) {
        var cmd = "merchantUpdate/employeeCommissionList";
...
function getSearchParam(pageNo, pageSize){
    ...
    $("#excelbtn").bind("click", function downloadFile() {
        ...
        try{
            ...
            var excelUrl = reqAjax('merchantUpdate/employeeCommissionListExport', getSearchParam());
            if(excelUrl.code != 1){
	...
	function seqNum(value,row,index){
		return index+1;
	}
