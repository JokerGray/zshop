...
var TableInit = function () {
  ...
  oTableInit.Init = function () {
    $('#table').bootstrapTable('destroy').bootstrapTable({
      ...
      columns: [
        ...
        {field: 'laborCostsMonthlyTotal', title: '当月总计劳务费', sortable: true, width: 200, align: "center",
            formatter: function (res) {
               return fmoney(res, 2);
            }
          },   
        ...
        {field: 'laborTaxMonthlyTotal', title: '当月累计劳务税', sortable: true, width: 200, align: "center",
            formatter: function (res) {
               return fmoney(res, 2);
            }
        },
  ...
  oTableInit.queryParams = function (params) {
    var cmd = "profitExtractLog/selLaborTaxDetail";
    var jsonData = "";
...
$("#excelbtn").bind("click", function downloadFile() {
  ...
  try {
    ...
    var excelUrl = reqAjax('scLaborTaxList/exportScLaborTaxDetail', jsonData);
    //2.获取下载URL
