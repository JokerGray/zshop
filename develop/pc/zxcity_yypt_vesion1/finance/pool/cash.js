...
$(function () {
    ...
    $('#selectplate').val(state);
    $('#selectplate').selectpicker('val', state);
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
                ...
                { field: 'state', title:'时间', sortable: true, width: 150, align : "center",
                    formatter: function(res,data){
						if(res == 0){
    ...
    oTableInit.queryParams = function (params) {
        ...
        jsonData = '{"state":"'+state+'","accountName":"'+station+'","phone":"'+phone+'","serialNo":"'+serialNo+'","applyTimeStart":"'+startTimes+'","applyTimeEnd":"'+endTimes+'","pageNo":'+pageNo+',"pageSize":'+pageSize+'}';
        return {
            cmd: cmd,
            data: jsonData,
            version: version
