    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
                ...
                { field: 'extractTypeStr', title:'业务类型', width: 150, align : "center",
                ...
                { field: 'extractMoney', title:'存入金额(人民币)', width: 150, align : "center",
					formatter: function(money){
						return fmoney(money, 2);
					}
				},// 金额格式化  // 存入金额
				{ field: 'extractTime', title:'存入时间',  sortable: true, width: 160, align : "center" },// 存入时间
