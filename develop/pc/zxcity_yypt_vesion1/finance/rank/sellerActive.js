(function($){
    var REQUEST_URL = {
        ...
        'query' : 'ranking/selRankingMerchantActive', //查询
        'export' : 'ranking/selRankingMerchantActive' //导出
    };
