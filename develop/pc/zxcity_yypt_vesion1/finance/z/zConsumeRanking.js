...
function callBacks(){
	...
	for(var i=0;i<currentPageData.length;i++){
		subTotalAmount += currentPageData[i].totalMoney;
	}
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'moduleName', title:'版块', align : "center", width: 80 }, // 所属版块
				{ field: 'goodsName', title:'商品名称', width: 150, align : "center" }, //商品名称
				{ field: 'totalNum', title:'数量', width: 80, align : "center" },//数量
				{ field: 'totalMoney', title:'总金额(单位：Z币)', width: 100, align : "center"
    ...
    oTableInit.queryParams = function (params) {
        var cmd = "payTransactionLog/zbConsumeRanking";
        var jsonData="";
...
function getSearchParam(pageNo, pageSize){
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            var excelUrl = reqAjax('payExcel/exportZbConsumeRankingInfo', getSearchParam());
            if(excelUrl.code != 1){
