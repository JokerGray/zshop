...
function callBacks(){
	...
	for(var i=0;i<currentPageData.length;i++){
		subTotalAmount += currentPageData[i].balance;
	}
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'username', title:'账户名称', align : "center", width: 80 }, // 账户名称
				{ field: 'phone', title:'电话号码', width: 150, align : "center" }, //电话号码
				{ field: 'ismerchant', title:'用户性质', width: 150, align : "center" }, //用户性质 0 平台用户/1 商户
				{ field: 'createTime', title:'创建时间', width: 80, align : "center" },//创建时间
				{ field: 'balance', title:'账户余额(单位：Z币)', width: 100, align : "center"} //账户余额
			],
...
function getSearchParam(pageNo, pageSize){
    ...
    var jsonData = {username: username, endTime: endTime};
    if(pageNo && pageNo){
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            var excelUrl = reqAjax('payExcel/exportZAccountDetail', getSearchParam());
            if(excelUrl.code != 1){
