...
//      searchText: '',
      ...
      columns: [
        ...
        {field: 'number', title: '消耗次数', sortable: true, width: 200, align: "center" },
        {field: 'subTotalSum', title: '消耗金额', width: 150, align: "center",
        ...
        onLoadSuccess: function (res) {
        	//展现视图
          	 try {
          		  ...
          		  var option = echartsCustomerFunction.initOption('智币消耗统计', ['消耗次数','消耗金额','智币余额'],xData, [yData['number'],yData['subTotalSum'],yData['ab']]);
  ...
  oTableInit.queryParams = function (params) {
    var cmd = "payTransactionLog/selConsumeStatistics";
...
$("#excelbtn").on("click", function downloadFile() {
  ...
  try {
    ...
    var excelUrl = reqAjax('payExcel/exportConsumeStatistics', getSearchParam());
    //2.获取下载URL
