            ...
            columns: [
				...
				{ field: 'payMoney', title:'支付金额(人民币)',  width: 150, align : "center",
					formatter: function(value,row){
                        ...
                        if(row.laborTaxCalculationVo && row.laborTaxCalculationVo.paymentAmount >= 0){
                            str = fmoney(row.laborTaxCalculationVo.paymentAmount, 2);
                        }
                        return '<button type="button" class="btn btn-xs btn-link" onclick="openView('+row.id+')">'+str+'</button>';
					}
				},
