    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'userTypeStr', title:'申请人身份', align : "center", width: 100 },
				{
					field:'name', title:'申请人', align : "center", width: 120 
				},
				{ field: 'phone', title:'手机号', align : "center", width: 130 },
				
				{ field: 'realMoney', title:'申请金额',  width: 130, align : "center",
					formatter: function(value,row,index){
						
						return value && value ? fmoney(value, 2) : null;
					}
				},
				{ field: 'taxType', title:'税务类型', width: 120, align : "center" },
				{ field: 'afterTaxAmount', title:'实付金额', width: 130, align : "center" ,
					formatter: function(value,row,index){
						return value && value ? fmoney(value,2) : null;
					}
				},
				{ field: 'laborTax', title:'扣税金额',  width: 130, align : "center" ,
					formatter: function(value,row,index){
						return value && value ? fmoney(value,2) : null;
					}
				},
				...
				{ field: 'modifyTime', title:'审核时间', width: 160, align : "center" },
				{
					field:'_z', title: '备注', align: 'center', width: 100,
					formatter: function(value,row,index){
						return '<button type="button" class="btn btn-xs btn-link" onclick="openView('+row.id+')">详情</button>';
					}
				}
			],
