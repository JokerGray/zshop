...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#table').bootstrapTable('destroy').bootstrapTable({
            ...
            columns: [
				...
				{ field: 'modular', title:'所属版块', width: 150, align : "center",
                ...
                { field: 'billMark', title:'收入分类', width: 150, align : "center",
                    formatter: function(res){
                        if(res==null){
                            return res="-";
                        }else{
				...
				{ field: 'platformType', title:'交易方式类型', sortable: true, width: 100, align : "center" ,
    ...
    oTableInit.queryParams = function (params) {
        ...
        //jsonData = "{'accountName':'"+station+"','billTimeStart':'"+startTimes+"','billTimeEnd':'"+endTimes+"','pageNo':"+pageNo+",'pageSize':"+pageSize+"}";
    ...
    $("#excelbtn").bind("click", function downloadFile() { 
        ...
        try{
            ...
            jsonData = "{'accountName':'"+station+"','billTimeStart':'"+startTimes+"','billTimeEnd':'"+endTimes+"'}";
