$(function(){
    layui.use(['form', 'layer', 'jquery', 'laydate', 'table', 'laypage', 'element'], function () {
        ...
        function zTreeOnClick(event, treeId, treeNode){
            ...
            $('#imgonlysee').show();
            $("#uploadImgsee").attr('src',imagePath);
            ...
            // console.log($('#level').attr('data-id'))
