!function (t, e) {
    ...
    function l(t, e) {
        ...
        var A = e.list || [], s = e.type || "list", l = e.onClick || J, d = o('<ul class="' + ("list" === s ? "w-e-list" : "w-e-block") + '"></ul>');
    ...
    u.prototype = {
        constructor: u, show: function () {
            ...
            if (!(G.indexOf(e) >= 0)) {
                var n = e.editor, i = o("body"), r = n.$textContainerElem, a = this.opt, c = o('<div class="w-e-panel-container"></div>'), A = a.width || 300;
        ...
        constructor: p, onClick: function (t) {
            ...
            var n = this, i = c("input-link"), r = c("input-text"), a = c("btn-ok"), A = c("btn-del"), s = this._active ? "inline-block" : "none", l = new u(this, {
                width: 300,
                tabs: [{
                    title: "链接",
        ...
        constructor: B, onClick: function (t) {
            var e = this.editor, n = e.selection.getSelectionStartElem(), i = e.selection.getSelectionEndElem(), r = e.selection.isSelectionEmpty(), a = e.selection.getSelectionText(), c = void 0;
        ...
        constructor: I, onClick: function () {
            ...
            if (t) {
                var e = t.tr, n = o(e.elem), i = t.td, r = i.length, a = document.createElement("tr"), c = "", A = void 0;
        ...
        constructor: _, onClick: function () {
            ...
            var t = this.editor, e = t.uploadImg, n = t.config, i = c("up-trigger"), r = c("up-file"), a = c("link-url"), A = c("link-btn"), s = [{
                title: "上传图片",
    ...
    j.prototype = {
        constructor: j, _alert: function (t, e) {
            ...
            var e = this;
            if (t && t.length) {
                var n = this.editor, i = n.config, o = i.uploadImgServer, c = i.uploadImgShowBase64, A = i.uploadImgMaxSize, s = A / 1e3 / 1e3, l = i.uploadImgMaxLength || 1e4, d = i.uploadFileName || "", u = i.uploadImgParams || {}, p = i.uploadImgParamsWithUrl, h = i.uploadImgHeaders || {}, f = i.uploadImgHooks || {}, g = i.uploadImgTimeout || 3e3, m = i.withCredentials;
                null == m && (m = !1);
    ...
    H.prototype = {
        constructor: H, _initConfig: function () {
            ...
            var t = this, e = this.toolbarSelector, n = o(e), i = this.textSelector, r = this.config, a = r.zIndex, A = void 0, s = void 0, l = void 0, d = void 0;
