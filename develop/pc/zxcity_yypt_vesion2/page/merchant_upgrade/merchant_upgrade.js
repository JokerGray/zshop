layui.use(['form', 'layer', 'jquery', 'laydate', 'table', 'laypage'], function() {
	...
	//接口
	var server = {
		merchantUpgradeConfirmList : 'operations/merchantUpgradeConfirmList', //(查询列表)
        approveMerchantUpgrade : 'operations/approveMerchantUpgrade' //(确认)
	}
	...
	$('#resetBtn').on('click', function() {
        $('.tool-box-ul').find('input,select').val('').parent().removeAttr('data-date');
        tableInit();
	})
