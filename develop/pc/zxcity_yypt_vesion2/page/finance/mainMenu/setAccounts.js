...
$(".srtq").click(function(){
	var name = "收入提取";
	var url = "page/finance/profitExtract/profitExtractSummary.html";
	parent.addTabs(url, name);	
});

$(".lwfcr").click(function(){
	var name = "劳务费存入";
	var url = "page/finance/profitExtract/laborProfitExtractList.html";
	parent.addTabs(url, name);	
});

$(".yz").click(function(){
	var name = "预支";
	var url = "page/finance/mainMenu/expenditure.html";
	parent.addTabs(url, name);	
});

$(".zfbsxfcr").click(function(){
	var name = "支付宝手续费存入";
	var url = "page/finance/profitExtract/apipayPoundageStoreSummary.html";
	parent.addTabs(url, name);	
});
