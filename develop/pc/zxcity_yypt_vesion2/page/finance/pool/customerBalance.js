layui.use(['form', 'layer', 'jquery', 'laydate', 'table', 'laypage'], function() {
			...
			//接口
			var server = {
				dataList: 'payStatistics/selectAllUserAccountBalance', //(查询列表)
				exportPayScInvoiceLog : 'payExcel/exportAllUserAccountBalance'//(下载地址)
			}
...
//							
						...
						success: function(index,layero) {
							...
							reqAjaxAsync('payStatistics/selectUserInfo',JSON.stringify(parms)).then(function(res){
								var data=res.data;
								$('#accountNum').val(data.platformUserCode);
								...
								$('#regMode').val(data.regMode);
								$('#isrealname').val(data.isrealname)
							})
						},
						yes: function(index,layero) {
							layer.close(index)
