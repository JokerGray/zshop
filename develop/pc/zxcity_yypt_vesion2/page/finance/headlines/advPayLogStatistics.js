layui.use(['form', 'layer', 'jquery', 'laydate', 'table', 'laypage'], function() {
	...
	//接口
	var server = {
		commissionReviewRecordList: 'headlines/selectStatisticsList', //(查询列表)
		commissionReviewRecordListExport: 'headlines/exportStatisticsList' //(模块列表)
	}
