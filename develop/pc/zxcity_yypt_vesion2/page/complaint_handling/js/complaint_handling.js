(function($) {
	...
	table.on('tool(demo)', function(obj) {
		...
		if(obj.event === 'detail') {
			...
			$(window.parent.document).find("iframe[data-id='"+onthisid+"']").attr("src","page/handling_detail/handling_detail.html?v=" + new Date().getMilliseconds());
			...
			var onthisid = $(window.parent.document).find(".top_tab li[class*='layui-this']").children("i.layui-icon").attr("data-id");
			console.log($(window.parent.document).find("iframe[data-id='"+onthisid+"']"));
			$(window.parent.document).find("iframe[data-id='"+onthisid+"']").attr("src","page/handling_detail/handling_detail.html?v=" + new Date().getMilliseconds());
			// window.top.admin.current("handling_detail/handling_detail.html?v=" + new Date().getMilliseconds());
			//window.top.admin.current("handling_detail/handling_detail.html");
			//$("#pageFrame",window.parent.document).attr("src","handling_detail/handling_detail.html");
