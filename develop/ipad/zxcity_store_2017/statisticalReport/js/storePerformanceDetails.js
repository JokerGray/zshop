(function($){
    var REQUEST_URL = {
        'bar_url':'shopStatistics/queryShopAchInfoSummeryDetials',//门店业绩柱状图
        'pie_url':'shopStatistics/queryShopProInfoSummeryDetials',//门店业绩饼状图
    ...
    var shopID = getUrlParams("shopID"),
        ...
        shopName = getUrlParams("shopName"),
    ...
    $("#barSearchBtn").click(function(){
        ...
        if(days > 30){
            layer.msg('起始日期与结束日期的时间间隔不得超过30天!');
            return;
        }
    ...
    $(function(){
        ...
        if(mType == ""){
            $("#salsumpTab .tab-ul .sale-detail-item, #salsumpTab .tab-ul .consume-detail-item").removeClass("hide");
        }else if(mType == 1){
            $("#salsumpTab .tab-ul .sale-detail-item").removeClass("hide");
        }else if(mType == 2){
            $("#salsumpTab .tab-ul .consume-detail-item").removeClass("hide");
        }
        initDateTime();
        getBarData(tabType, 1);
        //	getPieData(tabType, 1);
    ...
    $(".main-title .return-icon").click(function(){
        ...
        }else if(sessionStorage.getItem("prevPage") == 11){
            location.href = "./storePerformance.html";
        }else{
