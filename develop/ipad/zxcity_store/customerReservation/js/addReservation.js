(function($){
    ...
    var oCustomerInfo = null; //用于存放选择的客户信息
    //获取当前日期
    var now = new Date();
    ...
    $("#saveAddReservationBtn").click(function(){
        ...
        var bespokeDate = getBookDate(),//"2017-01-12",       // 预约日期
            ...
            waiterId = $("#selectTechnicianList .name").attr('data-id'),                         // 技师ID，**必填**
            waiterName = $("#selectTechnicianList .name").text(),              // 技师称谓，**必填**
    ...
    function openSelectTechnicianDialog(){
        ...
        if(res.code == 1){
            ...
            for(var i=0; i<obj.length; i++){
                ...
                var sHtml = '<li data-id="'+obj[i].id+'"><span>'+obj[i].username+'</span>';
                sHtml += '<select>'
        ...
        $("#technicianSelectBox .pop-inner .pop-con ul").delegate("li .btn", "click", function(){
            ...
            //如果技师预约时间变更，则清空预约房间信息，根据时间重新加载房间列表
